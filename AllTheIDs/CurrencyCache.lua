...
local CreateFrame, GetCurrentListInfo, GetCurrencyListInfo,
    ...
    = CreateFrame, C_CurrencyInfo.GetCurrentListInfo, C_CurrencyInfo.GetCurrencyListInfo,
        C_CurrencyInfo.GetCurrencyListSize, C_CurrencyInfo.GetCurrencyListSize, rawset, setmetatable
